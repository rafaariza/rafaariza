...
$$
\begin{align*}
  &\frac{4}{\xi+\eta}\left[\frac{\partial}{\partial \xi}\left(\xi\frac{\partial}{\partial \xi}\right)+\frac{\partial}{\partial \eta}\left(\eta\frac{\partial}{\partial \eta}\right)\right]f_1(\xi)f_2(\eta)e^{im\phi}\:-\\
...
$$
\begin{align*}
  &\Bigg\{\left[\frac{\partial}{\partial \xi}\left(\xi\frac{\partial}{\partial \xi}\right)+\frac{\partial}{\partial \eta}\left(\eta\frac{\partial}{\partial \eta}\right)\right]-\frac{m^2}{4\xi\eta}(\xi+\eta)\:-\\
