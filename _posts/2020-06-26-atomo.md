...
$$
\begin{equation}
  \left\{\frac{4}{\xi+\eta}\left[\frac{\partial}{\partial \xi}\left(\xi\frac{\partial}{\partial \xi}\right)+\frac{\partial}{\partial \eta}\left(\eta\frac{\partial}{\partial \eta}\right)\right]+\frac{1}{\xi\eta}\frac{\partial^2}{\partial \phi}-\frac{4(\nu_1+\nu_2)}{\xi+\eta}\right\}\Psi=\lambda^2\Psi
  \label{eq:tocho}
\end{equation}
$$