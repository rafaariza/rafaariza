...
$$
\begin{align*}
  &\frac{4}{\xi+\eta}\left[\frac{\partial}{\partial \xi}\left(\xi\frac{\partial}{\partial \xi}\right)+\frac{\partial}{\partial \eta}\left(\eta\frac{\partial}{\partial \eta}\right)\right]f_1(\xi)f_2(\eta)e^{im\phi}-\frac{m^2}{\xi\eta}f_1(\xi)f_2(\eta)e^{im\phi}-\frac{4(\nu_1+\nu_2)}{\xi+\eta}f_1(\xi)f_2(\eta)e^{im\phi}\:=\\
