...
Al no tener en nuestro sistema fuerzas externas $\vec{F}_{ext}=0$ el centro de masas hará un movimiento rectilíneo uniforme $\begin{cases} v\_{CM}=0& \\
v_{CM}=cte \end{cases}$.<br>
