...
Queremos expresar $\vec{r}_1$ y $\vec{r}_2$ en función de $\vec{r}_{CM}$ y $\vec{r}$. Resolvemos el sistema planteado por el cambio propuesto en  obteniendo:
...
$$\begin{aligned}
        ...
        &\:\vertarrowbox[3ex]{=}{$\dot{\vec{r}}_{CM}=\dot{\vec{v}}_{CM}$}\;v_{CM}^2+\frac{m_2^2}{M^2}|\dot{\vec{r}}|^2+2\frac{m_2}{M}\dot{\vec{r}}_{CM}\cdot\dot{\vec{r}}
    \end{aligned}$$
