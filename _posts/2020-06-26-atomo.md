...
Resolvemos el sistema planteado por el cambio propuesto del centro de masas obteniendo:
...
Al no tener en nuestro sistema fuerzas externas 

$$\vec{F}_{ext}=0$$ 

el centro de masas hará un movimiento rectilíneo uniforme 
...
$$\vec{r}_{CM}=\frac{m_1\vec{r}_1+m_2\vec{r}_2}{m_1+m_2}=\frac{m_1\vec{r}_1}{m_1+m_2}+\frac{m_2\vec{r}_2}{m_1+m_2}\approx\vec{r}_2$$
